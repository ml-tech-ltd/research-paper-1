...
and fuzzy systems; agents represent traders performing buy
and sell orders in a market, fuzzy systems are used to model the rules followed by
...
the interactions that provoke changes in the price. % Objectives should go first. - JJ
We use activation functions
to restrict the agents' behavior, simulating a trader's hesitancy when
performing trades. % an unknown to simulate another unknown. Challenges and objectives should go up front - JJ
Activation functions use the grades of membership obtained
...
conditions. % This is a  definition, and "activation" is probably not a good word to describe them. "Specialization" functions? - JJ
We have performed experiments and compared against the work by
Munkhdalai et al., % You have to prove that this is the state of the art. Alternatively, just say you are comparing against the state of the art - JJ
proving how capable our method in predicting
future market prices. % "proving how capable" is indeterminate. You need to say if it's better, or worse or in which sense it is that way - JJ
Results demonstrate that our method is competitive % in which sense
...
agents' behavior results in better predictive models.% Don't say what you use, say what they are used for: identifying specialized agents yields better results - JJ
\end{abstract}
...
% The paper needs to establish the state of the art, and this seems to be the section where you do it, including the reference to Munkhdalai; adding this to the title clarifies its role - JJ 
...
preprocess % the technical indicators do not preprocess - reformulate JJ
a market's raw data to distill different aspects of it,
...
performed the best for every forex market. Furthermore, the table
shows our results with and without the use of activation functions,
and it can be seen that the use of activation functions helps the
model to perform better. Table \ref{table:full-results} provides a

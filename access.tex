...
agents' behavior results in better predictive models.
...
\section{Introduction and State of the Art} % maybe add "and state of the art"? - JJ
...
A more robust approach is to preprocess the raw price data using technical indicators to distill different aspects of it \cite{Alsubaie2019}, 

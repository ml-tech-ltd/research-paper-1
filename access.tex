...
agent-based models. The advantage of these models capable of simulating the
...
To evaluate our model's predictive performance, we compare it against models
generated by RNN, LSTM, GRU, MLP, random forest, AdaBoost, XGBoost, and SVM. The
results lead us to conclude that our method proves to be competitive for
predicting forex markets, as shown in Tables \ref{table:comparison-rmse} and
\ref{table:comparison-mae}.
...
If we consider RMSE to be a more suitable metric to measure the

...
% "Agents" is repeated... Maybe simply "Using fuzzy rules..."
% Emphasize also what's really new. Using rules? The application? - JJ
% TODO 51: COMPLETE. Agreed!
...
market's behavior. Better and different % Better than that and different from what? - JJ
% TODO 52:
...
We have performed experiments against the work by Munkhdalai et
al. \cite{Munkhdalai2019}, which demonstrates how capable our method
is for predicting future market prices. % Checked against what? - JJ
% TODO 59: COMPLETE. I considered listing the methods, but these
% are mentioned below.
...
% "help to obvain" into "helps to obtain" or "results in" - Mac
% TODO 61: COMPLETE. Changed to "results in".
\end{abstract}
...
intuitionistic fuzzy sets, as in a Mamdani system~\cite{Mamdani1975}; alternatively, they can be used only for
...
% TODO 70:
The authors of the present paper have worked in a particular way of achieving this type of systems, 
and the method is described in~\cite{Hernandez-Aguila2016} and~\cite{Hernandez-Aguila2017-2}. 
...
used to model a trader's knowledge and how they take decisions % "make decisions" or "take trades" - Mac
according to a market's current conditions, and MAS are used to model
a collection of traders that are working in a market and thus creating
price fluctuations in it.
...
% TODO 75:
that solves a problem using agents. Agents can
...
beliefs and rules. % You should have simplified this to "MAS are composed of different, autonomous entities with "beliefs" and "rules" - JJ
% TODO 76:
...
sensing their environment to determine what actions to take according to their % "sensing" to "assessing"? - Mac
% TODO 77:
...
As mentioned before, agents can also be used to create agent-based models. % You should say this before the previous paragraph - JJ
% TODO 78:
These
...
related to decentralized MAS. % Again, too many words to fit the system in a classification. Just don't try to fit it in. Agents are decentralized, some mechanisms are centralized. - JJ
% TODO 82:
...
Indeterminacy surges as a consequent of the inclusion of non-membership to a % "surges" = serves? - Mac
% or "arises" - JJ
% TODO 86:
...
of their capability of modelling knowledge in a smoother way than their alternatives, 
...
restriction works as a coordination mechanism to ensure that not all the
...
% TODO 93:
In this case, the outputs of the agents are averaged. % But if outputs are "buy" or "sell" how are they averaged? - JJ
% TODO 94:
% , as
...
predictive model. % Not clear when this ends. After a number of iterations? - JJ
% TODO 95:
...
\begin{table*}[t]
  \caption{Results of our method where multi-agent systems do not use activation functions to restrict their actions} % Highlight the best results - JJ
  % TODO 105:
  \small
  \centering
  \begin{tabular*}{0.9\textwidth}{c @{\extracolsep{\fill}} ccccccc}
...
\cite{Munkhdalai2019}. % Describe what advantages might this method have over Munkhdalai. Explainability? - JJ
% TODO 111:

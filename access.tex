...
shows the sample sizes for the second version of the method. After
presenting the results for each metric, $t-value$s are presented,
along with the conclusions of the hypothesis tests for each
market---where we are trying to prove that the version of our method
with activation functions presents lower errors than the version
without activation functions. Favorable $t-value$s and conclusions are
found in bold. The parameters used for all the hypothesis tests can be

...
picking'' \ref{morse2010cherry} when choosing optimal hyperparameters
for the method. %
...
ILS.%  which is able to find satisfactory solutions in a
% relatively low number of iterations (100, in the case of the
% experiments presented in this work).
% however, total computational effort should be compared. Iterations, by themselves, are meaningles. Can you provide that comparison? - JJ
% TODO 106: COMPLETE. Removed. I cannot provide a comparison.
...
% You need to say why, what is in your method that makes it better. Amount of computation? - JJ
% TODO 109: COMPLETE. See TODO 107.
...
RMSE for comparing predictive models. %
% rephrase, not clear what you mean - JJ
% TODO 119: COMPLETE.
However, RMSE has also been reported to be more suitable than MAE when the
error distribution is expected to be Gaussian \cite{chai2014root},
which is the case for the presented work. If we consider RMSE to be a
...
hypothesis tests presented in Table \ref{table:full-results} we can
...
activation functions detriments the performance of our method if we
consider the other metrics. % The conclusion is not the result, the conclusion is why. You formulated a hypothesis when you added the activation function. Has this hypothesis been proved? - JJ
% TODO 110: COMPLETE.
...
Munkhdalai.
% Describe what advantages might this method have over Munkhdalai. Explainability? - JJ
% TODO 111: COMPLETE.

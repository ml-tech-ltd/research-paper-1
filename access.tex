...
% Intuitionistic fuzzy rules better? - JJ
% \title{Using Fuzzy Rules in Multi-Agent Systems
...
% Why not this one? Or a mixture of both? - JJ
% TODO 114: COMPLETE. How about this one?
\author{
...
\begin{abstract}
Financial market predictive models are tools that help us understand a
market's behavior. Distinct % Better than that and different from what? - JJ
% TODO 52: COMPLETE.
methods for generating these
predictive models are needed in order to obtain diverse insights
about a market. % Different from what? You mean diverse? - JJ
% TODO 53: COMPLETE. Yeah, I meant diverse.
This paper presents a method for creating forex market predictive models 
using multi-agent systems and fuzzy systems. Agents in our method
represent traders performing buy and sell
orders in a market. %
% "Agents in -- a market."You already said you are using multi-agent systems in the previous sentance, consider using "Agents in our(or "this") system" - Mac
% TODO 54: COMPLETE.
% "that are issuing" changed to "issuing" or "performing" since you use that throught the paper - Mac
% TODO 55: COMPLETE.
We use fuzzy systems to model the rules followed by
traders performing trades in a live market to simulate its prices. %
% Model against what? Where do you ground the model? - JJ
% TODO 118: COMPLETE.
% "when they -- a market." is very confusing. Consider "performing trades in a live market." - Mac
% TODO 56: COMPLETE.
Activation functions are used to restrict the
agents' behavior, simulating the hesitancy of a trader when
% Talk a bit about the type of activation functions 
% I think this is an important aspect of the paper - Mario
% TODO 4: COMPLETE.
% Consider "behavior, simulating the hesitancy of a trader when performing trades." - Mac
% TODO 57: COMPLETE. Agreed. The alternative sounds better.
performing trades. Activation functions use the grades of membership
...
% "specialized enough" into "correctly optimized" - Mac
% TODO 58: COMPLETE. I'm keeping "specialized." The agent is optimized to
% handle multiple conditions, but the agent will only trade when those
% conditions are above optimal.
We have performed experiments and compared against the work by Munkhdalai et
al. \cite{Munkhdalai2019}, which demonstrates how capable our method
is for predicting future market prices.
...
% TODO 5: COMPLETE. Not adding this due to word count. Already discussed with Mario.
% Are those used for every agent rules? Or as alternative models? - JJ
% TODO 60: 
that the use of activation functions to restrict the agents' behavior
results in better predictive models.
\end{abstract}
...
\section{Introduction} % maybe add "and state of the art"? - JJ
% TODO 92: COMPLETE. I'm hesitant to the idea, as I couldn't find any other
%% papers where they do this.
...
% remove "for a market which are" - Mac
% TODO 62: COMPLETED. Agreed, it sounds better.
...
% "the method to present" should that be "model"? - Mac
% TODO 63: COMPLETE. Yes, results (simulations) are inherently interpretable (in this case).
% You are correct, we're talking about generated models that are interpretable.
% restructure sentacne to "to present easily interpretable results to the user." - Mac
% TODO 64: COMPLETE. Agreed. It sounds better.
...
% hesitancy when performing trades, thus helping us to better understand
% the behavior of a market.
% The above two paragraphs are repeats. One starts "The method presented"
% the other "The work presented" - Mac
% TODO 112: COMPLETE. Oops. The TODO label is also repeated.
...
\cite{Gao2019} \cite{Yu2015} \cite{Yu2015}, enabling faster
...
where solutions are found using ILS.
...
possible. % Formulate an hypothesis of why this is going to be a good thing. Since this is one of the results of the paper, you need to prove that you were right in the end - JJ
% TODO 93: COMPLETE.
...
has been reached. % Not clear when this ends. After a number of iterations? - JJ
% TODO 95: COMPLETE.
...
at this link:
\underline{https://bitbucket.org/overmind-group/workspace/projects/OT}.% Is it open source? Can it be accessed somehow? - JJ
% TODO 99: COMPLETE.
...
% Please clarify if it's significant or not - JJ
% TODO 101: COMPLETE.
...
% competitive, relative to the other methods presented in the tables, in the sense that. % in the sense that...
% TODO 102: COMPLETE. I'm removing this. I think the text added
%% for TODO 101 makes this sentence unnecessary.
...
\begin{table*}[t]
  ...
  % Indicate also when that difference is significant. It *looks* significant, but it might not really be as in some cases it's very small - JJ
  % TODO 103: COMPLETE. Being able to say that the difference is significant would require statistical testing,
  %% which cannot be done because Munkhdalai did not provide standard devations and the experiments are performed differently.
  %% Do you have any other ideas on how I could do this? Maybe mention those that are obviously too different (for example, 0.1 vs 0.001).
  %% I'm marking this as complete because I can't find a way of properly indicating when the differences are significant.
  \scriptsize
  \centering
...
\begin{table*}[t]
  ...
  % Also highlight only when differences with the second best is significant - JJ
  % TODO 104: COMPLETE. See TODO 103.
  \scriptsize
  \centering
  \begin{tabular*}{0.9\textwidth}{c @{\extracolsep{\fill}} ccccccc}
    \hline
...
these experiments were not considered.  After presenting the results
for each metric, $t-value$s are presented, along with the conclusions
of the hypothesis tests for each market---where we are trying to prove
that the version of our method with activation functions presents
lower errors than the version without activation functions. Favorable
$t-value$s and conclusions are found in bold. The parameters used for
all the hypothesis tests can be found in Table
\ref{table:parameters-tests}.

\begin{table*}[t]
  \caption{Results of our method with and without activation functions to restrict their actions} % Highlight the best results - JJ
  % TODO 105: COMPLETE.
  \scriptsize
  \centering
  \begin{tabular*}{0.9\textwidth}{c @{\extracolsep{\fill}} ccccccc}
    ...
    \hline
    \hline
                                        & $t-value$ & \textbf{-2.71555} & \textbf{-9.13914} & \textbf{-6.74278} & \textbf{-5.2259} & \textbf{-4.3400} & \textbf{-4.7952} \\
                                        & Conclusion & \textbf{Reject $H_0$} & \textbf{Reject $H_0$} & \textbf{Reject $H_0$} & \textbf{Reject $H_0$} & \textbf{Reject $H_0$} & \textbf{Reject $H_0$} \\
    \hline
    \hline
    \multirow{3}{*}{MAPE} & Mean & 4.49\e{-03} & 2.89\e{-01} & 3.70\e{-03} & 6.53\e{-03} & 4.51\e{-03} & 4.32\e{-03} \\
                                        & Std dev & 2.47\e{-03} & 1.01\e{-01} & 1.73\e{-03} & 3.50\e{-03} & 1.99\e{-03} & 1.88\e{-03} \\
    \multirow{3}{*}{MAPE\textsubscript{AF}} & Mean & 6.04\e{-03} & 2.93\e{-01} & 3.92\e{-03} & 6.10\e{-03} & 4.53\e{-03} & 5.53\e{-03} \\
                                        & Std dev & 4.38\e{-03} & 1.50\e{-01} & 2.47\e{-03} & 3.19\e{-03} & 2.07\e{-03} & 3.20\e{-03} \\
    \hline
    \hline
                                        & $t-value$ & 2.2248 & 0.1618 & 0.5520 & -0.6768 & 0.0513 & 2.2406 \\
    ...
    \multirow{2}{*}{MSE\textsubscript{AF}} & Mean & 6.81\e{-05} & 2.62\e{-01} & 2.95\e{-05} & 6.46\e{-05} & 3.62\e{-05} & 5.25\e{-05} \\
                      & Std dev & 9.54\e{-05} & 2.52\e{-01} & 3.55\e{-05} & 6.77\e{-05} & 3.29\e{-05} & 5.49\e{-05} \\
    \hline
    \hline
                                        & $t-value$ & 1.7444 & -1.6066 & 0.3111 & \textbf{-2.8524} & -0.0057 & 2.0642 \\
                                        & Conclusion & Fail to reject $H_0$ & Fail to reject $H_0$ & Fail to reject $H_0$ & \textbf{Reject $H_0$} & Fail to reject $H_0$ & Fail to reject $H_0$ \\
    \hline
    \hline
...
%     \multicolumn{2}{c}{\textbf{Metric}} & \textbf{EUR/USD} & \textbf{USD/JPY} & \textbf{USD/CHF} & \textbf{GBP/USD} & \textbf{USD/CAD} & \textbf{AUD/USD} \\
%     \hline
%     \multirow{2}{*}{MAE_{AF}} & Mean & 3.27\e{-03} & 1.81\e{-01} & 1.95\e{-03} & 3.80\e{-03} & 3.32\e{-03} & 2.74\e{-03} \\
%                       & Std dev & 3.81\e{-03} & 1.31\e{-01} & 1.53\e{-03} & 3.12\e{-03} & 1.94\e{-03} & 2.25\e{-03} \\
%     \hline
%     \multirow{2}{*}{MAPE_{AF}} & Mean & 6.04\e{-03} & 2.93\e{-01} & 3.92\e{-03} & 6.10\e{-03} & 4.53\e{-03} & 5.53\e{-03} \\
%                        & Std dev & 4.38\e{-03} & 1.50\e{-01} & 2.47\e{-03} & 3.19\e{-03} & 2.07\e{-03} & 3.20\e{-03} \\
%     \hline
%     \multirow{2}{*}{MSE_{AF}} & Mean & 6.81\e{-05} & 2.62\e{-01} & 2.95\e{-05} & 6.46\e{-05} & 3.62\e{-05} & 5.25\e{-05} \\
%                       & Std dev & 9.54\e{-05} & 2.52\e{-01} & 3.55\e{-05} & 6.77\e{-05} & 3.29\e{-05} & 5.49\e{-05} \\
%     \hline
%     \multirow{2}{*}{RMSE_{AF}} & Mean & 7.12\e{-03} & 5.63\e{-01} & 5.11\e{-03} & 7.79\e{-03} & 5.70\e{-03} & 5.81\e{-03} \\
%                        & Std dev & 5.15\e{-03} & 2.98\e{-01} & 3.21\e{-03} & 4.05\e{-03} & 2.36\e{-03} & 3.72\e{-03} \\
...
% Please say what was the motivation of this work and what problem you tried to solve before saying that you did it - JJ
...
XGBoost and SVM. % Can this be generalized? - JJ
...
fuzzy systems, with the exception of GBP/USD. % Conclusions shouldn't just enunciate results (that should be done above), it should try and explain why they happen. Is there something in that specific dataset that makes it work better without AF? - JJ
% TODO 107: COMPLETE. I'm gluing up these three paragraphs into a single paragraph.
%% My intention with these paragraphs is to serve as an introduction for the next paragraph, which
%% discuss why the results with MAE are more relevant than those with RMSE. I also discuss that
%% the experiments against Munkhdalai are not statistically conclusive. Then I added some statistical tests and I mention them.
%% Please add another comment if you still think things must change in this section. Maybe rewrite the section? If this is
%% the case, I'd find a general outline very useful.
...
% Again, you need to explain why or make an hypothesis of why that happens - JJ
% TODO 108: COMPLETE. See TODO 107.
Table
...
% You would need to generalize this, so that someone decides, on the basis of this characterization, whether your method or Munkdalai's is better - JJ
...
which is the case for the presented work. % You just said above it's not, at least in one case? - JJ
...
hypothesis tests %hypothesis or tests?  JJ
presented in Table \ref{table:full-results} we can
conclude that the use of activation functions dramatically improves
our method's performance, if we consider MAE. However, the use of
activation functions goes in detriment of the performance of our method if we
consider the other metrics. % Please summarize. I'm kind of lost. You seem to be drawing conclusions on how to measure performance, but there should be an objective way of doing so: ROI? You're kind of saying our method is good, but only if we measure it that way. If we do it in some other way, well, not so good. What's the deal then? Is this paper about evaluation of metrics? You need to give conclusive results in the conclusion. We think this metric is better, so our method is better and that's that. - JJ
...
\cite{Munkhdalai2019}. However, it must be noted that our method has
the advantage of being more interpretable than the method proposed by
Munkhdalai.
% This is not proved, however. You need to show the method and how to interpret it. You have evaluated your method and compared it in a number of ways, and they said that the result is not conclusive. So why did you compare it? Shouldn't you compare it in tasks that are similar? - JJ
...
% Change "meta-heuristic" to "iterated local search".
% TODO 120: COMPLETE.

% Create hypothesis tests for with vs without activation functions.
% TODO 121: COMPLETE.

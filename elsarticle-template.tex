...
%% Multiple agents can be activated.
...
%% As mentioned before, agents are assigned subsets of training data set.
%% But in testing, they can collide. Their output is averaged.
